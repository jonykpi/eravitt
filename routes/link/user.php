...
Route::group(['prefix'=>'user','namespace'=>'user','middleware'=> ['auth','user', 'lang']],function () {
    ...
    Route::get('coin-swap', 'WalletController@coinSwap')->name('coinSwap');
    Route::post('swap-coin', 'WalletController@swapCoin')->name('swapCoin');
    Route::get('coin-convert-history', 'WalletController@coinSwapHistory')->name('coinSwapHistory');
