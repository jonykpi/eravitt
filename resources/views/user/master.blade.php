            ...
            <ul id="metismenu">
                ...
                <li class=" @if(isset($menu) && $menu == 'coin_request') cp-user-active-page mm-active @endif">
                    ...
                    <ul class=" @if(isset($menu) && $menu == 'coin_request') mm-show @endif">
                        <li class="@if(isset($sub_menu) && $sub_menu == 'withdrawal_coin') cp-user-submenu-active @endif">
                            <a href="{{route('withdrawalCoin')}}">{{__('Withdrawal Coin')}}</a>
                        </li>

                        <li class="@if(isset($sub_menu) && $sub_menu == 'default_withdrawal_coin') cp-user-submenu-active @endif">
                            <a href="{{route('defaultWithdrawalHistory')}}">{{__('Withdrawal History')}}</a>
                        </li>
