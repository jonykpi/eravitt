                    ...
                    <div class="cp-user-coin-rate">
                        @if($no_phase)
                            <ul class="">
                                ...
                                <li>=</li>
                                <li>{{number_format($coin_price,2)}} USD</li>
                            </ul>
                        ...
                        @else
                            ...
                            <ul class="ico-phase-ul">
                                ...
                                <li>
                                    <p>{{ __('Phase Rate')}} :</p>
                                    <p>1 {{ settings('coin_name') }} = {{number_format($phase->rate,2)}} USD</p>
                                </li>
...
{{--                                    <p>{{ $phase->fees }}%</p></li>--}}
                            ...
                            <ul class="ico-phase-ul ico-phase-amount">
                                ...
                                <li class="total_target">
                                    ...
                                    {{ number_format($target,2) }} {{ settings('coin_name') }}
                                </li>
                            </ul>
                            <div class="ico-phase-progress-bar">
                                <div class="progress" data-toggle="tooltip" data-placement="top"
                                     title="{{__('Raised Amount')}} ({{number_format($progress_bar,2)}} %)">
